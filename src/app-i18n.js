...
const resources = {
  'zh-CN': { translation: {
    'app.name': '简历编辑器', 'app.edit': '编辑', 'app.theme': '选择主题', 'app.language': '界面语言', 'app.a4': 'A4', 'app.spacing': '排版', 'app.reset': '重置', 'app.export': '导出', 'app.hide': '隐藏', 'app.show': '展开',
    ...
    'app.openJson': '打开 JSON 编辑器', 'app.closeJson': '关闭 JSON 编辑器', 'app.spacingTitle': '排版设置', 'app.spacingHint': '修改会实时反映在简历预览中', 'app.resetSpacing': '恢复默认排版', 'app.toolbarAria': '简历编辑工具栏', 'app.restoreAria': '展开编辑工具栏', 'app.restoreTitle': '展开编辑工具栏（Alt/Option + E）', 'app.printTitle': '打印或导出 PDF', 'app.a4Title': '切换 A4 分页预览',
  ...
  'en-US': { translation: {
    'app.name': 'Resume Editor', 'app.edit': 'Edit', 'app.theme': 'Theme', 'app.language': 'Language', 'app.a4': 'A4', 'app.spacing': 'Layout', 'app.reset': 'Reset', 'app.export': 'Export', 'app.hide': 'Hide', 'app.show': 'Show',
    ...
    'app.openJson': 'Open JSON editor', 'app.closeJson': 'Close JSON editor', 'app.spacingTitle': 'Layout settings', 'app.spacingHint': 'Changes are reflected in the preview instantly', 'app.resetSpacing': 'Reset layout', 'app.toolbarAria': 'Resume editor toolbar', 'app.restoreAria': 'Show resume editor toolbar', 'app.restoreTitle': 'Show toolbar (Alt/Option + E)', 'app.printTitle': 'Print or export PDF', 'app.a4Title': 'Toggle A4 pagination preview',
